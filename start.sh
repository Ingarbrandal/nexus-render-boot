...
# Standard 2GB: install the full lockfile. Filtering individual packages
# breaks import-time deps (playwright, pdfplumber). Do not run
# `playwright install` — Python wheel only.
